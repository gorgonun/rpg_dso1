...
class Village(Place):
    ...
    def kill_bear(self):
        return {"move": self.map_state(self.full_path) + "nobear", "imediate_consequence": "you take an arrow in your pouch and, with your ranger skill, kill the bear with one arrow in his head"}

    def go_away(self):
        return {"move": self.map_state(self.full_path + " village"), "imediate_consequence": "You go away, trying to not be envolved in problems. You go to the village."}
